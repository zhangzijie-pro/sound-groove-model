...
- If you change an artifact format, update the schema docs in `docs/specs/`.
...
- `feat: add json speaker bank with open-set identification`
- `fix: align resowave embedding parameter names`
- `docs: tighten checkpoint and data schema docs`
- `ci: add tag-driven wheel release workflow`
